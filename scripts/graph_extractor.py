...
DOC_TYPE_BY_FOLDER: tuple[tuple[str, str, str], ...] = (
    ("docs/00_constitution", "CONSTITUTION", "Constitution"),
    ("docs/01_vision", "VISION", "Vision"),
    ("docs/02_business_case", "BUSINESS_CASE", "BusinessCase"),
    ("docs/04_systems", "SYS-", "System"),
    ("docs/05_subsystems", "SUB-", "Subsystem"),
    ("docs/06_architecture", "", "ArchitectureDocument"),
    ("docs/07_decisions", "ADR-", "ADR"),
    ("docs/08_roadmap", "ROADMAP", "Roadmap"),
    ("docs/09_milestones", "MS-", "Milestone"),
    ("docs/10_features", "FEAT-", "Feature"),
    ("docs/11_tasks", "TASK-", "Task"),
    ("docs/12_validation", "VAL-", "ValidationReport"),
    ("docs/13_context_packages", "CP-", "ContextPackage"),
    ("docs/14_prompts", "PROMPT-", "CodingPrompt"),
    ("docs/20_semantic_compression/summaries", "", "SemanticSummary"),
    ("docs/20_semantic_compression/ultra", "", "SemanticSummary"),
    ("docs/21_execution_plans", "EP-", "ExecutionPlan"),
    ("docs/22_goal_impact", "GOAL-IMPACT-", "GoalImpact"),
)
...
def resolve_reference(root: Path, base_path: Path, ref: str) -> Path | None:
    ...
    if re.match(r"^\d{2}_", first) and not clean.startswith("docs/"):
        candidates.append((root / "docs" / clean).resolve())
